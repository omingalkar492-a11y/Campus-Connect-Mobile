...
import { FoodItem, Order, PaymentMethod, FoodCourtPayoutConfig } from '@/types';
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      const newOrder = await DataService.createOrder({
        ...
        studentIdentifier: `${profile.rollNumber || '3104'} · ${profile.division || 'Div A'}`,
        items: itemsToOrder,
    ...
    <View style={[styles.safeContainer, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <Text style={[styles.screenSub, { color: colors.textMuted }]}>
          Order fresh food ahead, avoid queues, and pick up with your OTP.
        </Text>
        ...
        <View style={styles.cartModalContainer}>
          <View style={styles.cartModalHeader}>
            <View>
              ...
              <Text style={styles.cartModalSub}>JSPM Main Canteen Hub</Text>
            </View>
            <Pressable
            ...
            <View style={styles.paymentSection}>
              ...
              <View style={styles.paymentOptionsRow}>
                ...
                >
                  ...
                  <Text style={styles.paymentOptionDesc}>Staff confirmation required</Text>
                </Pressable>
              </View>
          ...
          <View style={styles.confirmOverlay}>
            <View style={styles.confirmCard}>
              ...
              <Text style={styles.confirmDesc}>
                Food court staff has received your order. Show this secure OTP at the counter
                when your order is ready:
              </Text>

              <View style={styles.confirmOtpBox}>
                <Text style={styles.confirmOtpLabel}>YOUR PICKUP OTP</Text>
                <Text style={styles.confirmOtpCode}>{confirmedOrder.pickupOtp}</Text>
              </View>

              <Text style={styles.confirmPaymentNote}>
                Payment:{' '}
                {confirmedOrder.paymentMethod === 'UPI'
                  ? 'Paid & Verified via UPI'
                  : 'Pay cash to staff upon pickup'}
              </Text>
              ...
              >
                <Text style={styles.doneBtnText}>Track Order on Home</Text>
              </Pressable>
            </View>
          </View>
        </Modal>
